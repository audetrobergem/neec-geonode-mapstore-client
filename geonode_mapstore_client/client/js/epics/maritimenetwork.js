 ...
 */
export const gnUpdateMaritimeNetworkMapLayoutEpic = (action$, store) => action$.ofType(UPDATE_MAP_LAYOUT, SET_CONTROL_PROPERTY)
    .filter(() => store.getState()?.controls?.maritimeNetwork?.enabled)
    .filter(({ source }) => {
...
export default {
    gnUpdateMaritimeNetworkMapLayoutEpic,
};