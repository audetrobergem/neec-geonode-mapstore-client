...
import { setSelectedDatasetPermissions, setSelectedLayerType, setLayerResource } from '@js/actions/gnresource';
...
export const gnCheckSelectedDatasetPermissions = (action$, { getState } = {}) =>
    action$.ofType(SELECT_NODE, INIT_STYLE_SERVICE)
        ...
        || !nodeType && !getConfigProp("disableCheckEditPermissions") || !nodeType && !getConfigProp("disableCheckEditPermissions"))
        .switchMap(() => {
